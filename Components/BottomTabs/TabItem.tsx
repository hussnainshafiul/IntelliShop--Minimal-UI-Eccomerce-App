...
import { SCREEN_WIDTH } from '../../constants/Screend';
...
const AnimatedIcon = Animated.createAnimatedComponent(Feather) as React.ComponentType<any>;
...
const TabItem: FC<TabProps> = ({ label, icon, index, activeIndex, onTabPress }) => {
  ...
  const iconColor = useSharedValue(activeIndex === index + 1 ? 'white' : 'rgba(128,128,128,0.8)');
